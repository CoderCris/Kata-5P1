...
public class Kata5 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException, FileNotFoundException, IOException {
        ...
        String urlConnection = "jdbc:sqlite:Kata5-PRUEBA.DB";
        try (Connection connection = DriverManager.getConnection(urlConnection); Statement statement = connection.createStatement()) {
            ...
            System.out.println("Se han introducido "+registerCount+" registros." );
        }
     }
 }